...
public class UpdateEnrollController extends ProfMainMenuController {
    ...
    void submit(MouseEvent event) {
        ...
        try {
            ...
            preSql = this.conn.prepareStatement("UPDATE enroll SET "
                    + "ENROLL_ASSESS = ?, "
                    + "ENROLL_MIDTERM = ?, "
                    + "ENROLL_FINAL = ? "
                    + "WHERE STU_NUM = ? AND CLS_CODE = ?");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        in_stu.setText(String.valueOf(this.enroll_edit.getSTU_NUM()));
        in_cls.setText(this.enroll_edit.getCLS_CODE());
        dp_time.setValue(this.enroll_edit.getENROLL_DATE().toLocalDate());
        tf_assess.setText(String.valueOf(this.enroll_edit.getENROLL_ASSESS()));
        tf_midterm.setText(String.valueOf(this.enroll_edit.getENROLL_MIDTERM()));
        tf_final.setText(String.valueOf(this.enroll_edit.getENROLL_FINAL()));
    }
